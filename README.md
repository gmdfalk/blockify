...
**Blockify currently does not support Spotify version 1.0.0 and higher.** You can use a blacklist-based blocker like [spotify-blacklist-mute](https://github.com/ysangkok/spotify-blacklist-mute) instead.
